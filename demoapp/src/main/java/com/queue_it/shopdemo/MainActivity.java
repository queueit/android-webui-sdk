...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String waitingRoomDomain = sharedPreferences.getString("waitingRoomDomain", "");
        String queuePathPrefix = sharedPreferences.getString("queuePathPrefix", "");
    ...
    private QueueITEngine getQueueITEngine(SharedPreferences sharedPreferences) {
        ...
        String enqueueToken = enqueueTokenEditText.getText().toString();
        String enqueueKey = enqueueKeyEditText.getText().toString();
        String waitingRoomDomain = waitingRoomDomainEditText.getText().toString();
        String queuePathPrefix = queuePathPrefixEditText.getText().toString();
        ...
        editor.putString("waitingRoomDomain", waitingRoomDomain);
        editor.putString("queuePathPrefix", queuePathPrefix);
        editor.commit();
    ...
    private QueueITWaitingRoomProvider getSessionEngine(SharedPreferences sharedPreferences) {
        ...
        return new QueueITWaitingRoomProvider(
                MainActivity.this,
                customerId,
                eventOrAliasId,
                layoutName,
